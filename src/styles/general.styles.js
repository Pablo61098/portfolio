...
const ReduxSection = ({children, margin, down, blur, currentState}) => {
    ...
    return (
        <SectionStyling className="section" margin={margin} down={down} blur={blur} currentState={currentState}>
...
const loadStyles = () => {
    ...
    const SectionStyling = styled.section`
        ...
        .showWhenLoadComplete{
            ...
            color: ${p => p.currentState ? `#ffff` :`#000`}; /* Here to change color of fonr of all website*/
    ...
    return {TitleSectionEstilo, SectionStyling}
}
